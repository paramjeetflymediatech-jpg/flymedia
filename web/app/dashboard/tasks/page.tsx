    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="space-y-4">
            {tasks.map((task) => (
                <div key={task._id} className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-4 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-all">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-400">{task.project?.name || 'No Project'}</p>
                        </div>
                    </div>
